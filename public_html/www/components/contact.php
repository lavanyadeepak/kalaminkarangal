                         ...
                         <div class="sup-content">
                             ...
                             <div class="contact-title">
                                 ...
                                 <ol>
                                     ...
                                     <li><i class="fal fa-mobile"></i>+91 98411 60753 </li>
                                     <li><i class="fal fa-envelope"></i>support@kalaminkarangal.com</li>
                                     <li><i class="fal fa-clock"></i>Mon - Sun 8.00 - 21.00 (Indian Time)</li>
                                     <li><i class="fal fa-whatsapp"></i>Test</li>
                                 </ol>
                             </div>
                         </div>
                     </div>
